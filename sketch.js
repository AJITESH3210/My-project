...
function setup() {
  ...
  button.mousePressed(function(){
    ...
    button1.position(displayWidth - 300, displayHeight - 200); 
      ...
      button1.mousePressed(function(){
        ...
        document.write("Welcome to “Boost Your Brain” app. This app is developed by  J AJITESH of class IX, student at WHITEHAT JR.With the help of this app, you can check your concentration through a series of games. You will get some tips. By practicing the tips you can improve your concentration. You will also get to know the symptoms of lack of concentration.");
        
        button3 = createElement("Next");
        button3.position(displayWidth - 300, displayHeight - 200);
        
        button3.mousePressed(function(){
          button2.hide();
          document.write(" Symptoms which we lack in Concentration  •	We think one, but do another one.•	The inability of remembering things that occurred short time ago.•	While doing a work, thinking about past failures or success.•	Lack of confidence and planning.•	Lack of time management.•	Always thinking about competitors. •	Negative thoughts.•	Thinking about different personal problems while doing some work. ");
        });
  ...
  ball11 = createSprite(random(0, width), random(0, height), 60, 60);
...
//ball11.velocityX = random(-5, 25);
//ball11.velocityY = random(-5, 25);
...
function draw() {
 ...
 if(frameCount === 600){
   ...
   ball11.x = X;
   ball11.y = Y;
    if(ball11.overlap(ball10)){
      text("You Win",displayWidth/2 - 300, displayHeight/2 - 200 );
    }
  }
